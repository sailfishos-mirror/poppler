...
// Copyright (C) 2006, 2008, 2010-2013, 2017-2022, 2024-2026, Albert Astals Cid <aacid@kde.org>
...
public:
    ...
    Ref addStreamObject(std::unique_ptr<Dict> dict, std::vector<char> buffer, StreamCompression compression);
